...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center pt-32 pb-20 px-6 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-radial from-red-600/15 via-transparent to-transparent opacity-40 z-0" />
      <div
        ...
        style={{
          ...
          maskImage:
            "radial-gradient(ellipse 70% 50% at 50% 0%, black 30%, transparent 70%)",
        }}
      />

      <div className="relative max-w-7xl mx-auto w-full grid md:grid-cols-2 gap-12 items-center z-10">
        <div className="space-y-6">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-red-600/10 border border-red-600/30 rounded-full animate-slide-in-left">
            <div className="w-2 h-2 bg-red-600 rounded-full animate-pulse" />
            <span className="text-xs font-bold uppercase tracking-widest text-red-600">
              The Financial Reckoning Has Begun
            </span>
          </div>
          <h1 className="text-6xl md:text-8xl font-black leading-none tracking-tight animate-fade-in-up">
            WAKE THE
            <br />
          ...
          <p className="text-xl text-gray-400 leading-relaxed max-w-lg animate-fade-in-up animation-delay-200">
            Your fleet is bleeding{" "}
            <strong className="text-white">$180,000 to $1.2M annually</strong>{" "}
            on missed warranties, duplicate billing, and phantom broker
            deductions.
            <br />
            <br />
            That's not "cost of doing business."{" "}
            <span className="text-red-600 font-bold underline decoration-red-600/40 underline-offset-4">
              That is theft.
            </span>
          </p>
          <div className="flex flex-col sm:flex-row items-start gap-6 animate-fade-in-up animation-delay-400">
            <a
              href="#cta"
              className="group bg-red-600 text-white px-10 py-5 font-bold text-sm uppercase tracking-wider transform -skew-x-12 hover:bg-red-700 transition-all hover:-translate-y-1 hover:shadow-2xl hover:shadow-red-600/40 flex items-center gap-3"
            >
        ...
        <div className="relative bg-gradient-to-br from-zinc-900 to-zinc-800 border border-white/10 p-8 rounded-none animate-slide-in-right">
          ...
          <div className="relative space-y-6">
            ...
            <p className="text-xs text-gray-500 text-center">
              Based on industry avg of{" "}
              <strong className="text-white">$4,200/truck/year</strong> in
              recoverable losses
            </p>
          </div>
        </div>
